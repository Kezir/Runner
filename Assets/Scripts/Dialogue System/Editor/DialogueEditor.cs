...
namespace RPPG.Dialogue.Editor
{
    public class DialogueEditor : EditorWindow
    {
        ...
        private void OnEnable()
        {
            ...
            nodesStyle.normal.textColor = Color.white;
            nodesStyle.padding = new RectOffset(20, 20, 20, 20);
            ...
            playerNodesStyle.normal.textColor = Color.white;
            playerNodesStyle.padding = new RectOffset(20, 20, 20, 20);
        ...
        private void NewDrawLinkButtons(DialogueNode node)
        {
